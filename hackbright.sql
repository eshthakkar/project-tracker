...
3	Madlibs	Uses flask to create a responsive web server	70
4	Shopping Cart	Using sessions to create a shopping cart	90
5	SQL Quiz	Tests user SQL queries	40
\.
